...
class Helper {
  ...
  public static function customizer_tmpls() {
    ...
    $templates = [
      ...
      'template-4'      => ['label' => esc_attr__('Template Grid'), 'options'   => $tmpl_options],
   ...
   * @return [type]        [description]
   */
  public static function openHours($store, $format) {

    $timings = self::_getHoursInFormat($store->open_hours, $format);
   ...
   */
  public static function _getHoursInFormat($hours, $format) {
        ...
        if(is_object($open_hours)) {
          ...
          foreach($open_hours as $key => $_day) {
            ...
            if($_day && is_array($_day)) {
              ...
              $timings  .= '<div class="sl-day">';
              $timings  .= '<div class="sl-day-lbl">'.$days_str[$key].'</div><div class="sl-timings">';
              $timings  .= '<span class="sl-time">'.esc_attr__( 'Closed','asl_locator').'</span>';
              $timings  .= '</div></div>';
            }
