...
== Upgrade Notice ==
* 2.2.6:  Added a button to duplicate an API endpoint. Various tweaks, fixes, and improvements. See the changelog for full details. A recommended update for all.