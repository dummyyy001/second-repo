<?php 
if ( ! class_exists( 'KT_PW_CMB2_Field_Select2' ) ) {

	class KT_PW_CMB2_Field_Select2 {
	    /**
	    ...
	    public function setup_admin_scripts() {
	        wp_register_script( 'ktrc-select2', KTG_URL  . 'admin/cmb_select2/select2.js', array( 'jquery-ui-sortable' ), '4.0.3' );
	        wp_enqueue_script( 'kt-select2-init', KTG_URL  . 'admin/cmb_select2/cmb_select2_script.js', array( 'cmb2-scripts', 'ktrc-select2' ), self::VERSION );
	        wp_enqueue_style( 'kt-select2', KTG_URL  . 'admin/cmb_select2/cmb_select2_styles.css', false, self::VERSION );
	    }
	}
	$kt_pw_cmb2_field_select2 = new KT_PW_CMB2_Field_Select2();
}