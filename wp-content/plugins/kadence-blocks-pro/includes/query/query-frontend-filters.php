...
class Query_Frontend_Filters {
	 ...
	 */
	public static function build( $parsed_blocks, $ql_query_meta, $query_builder, $query_args = array() ) {
		foreach ( $parsed_blocks as $block ) {
			self::parse_item_from_block( $block, $ql_query_meta, $query_builder, $query_args );
			// Recurse.
	...
	public static function parse_item_from_block( $block, $ql_query_meta, $query_builder, $query_args ) {
		...
		if ( 'kadence/query-filter-date' === $block['blockName'] && ! empty( $block['attrs']['uniqueID'] ) ) {
			...
			self::$return[ $attrs['uniqueID'] ] = self::build_generic_filter( $attrs, $source, $taxonomy, $exclude_values, $include_values, $show_children, $show_hierarchical, $show_result_count, $post_type, $post_field, $placeholder, $block, $query_args, $hash );
		}
	}
	...
	public static function build_generic_filter( $attrs, $source, $taxonomy, $exclude_values, $include_values, $show_children, $show_hierarchical, $show_result_count, $post_type, $post_field, $placeholder, $block, $query_args, $hash ) {
		$options_array = self::build_options_array( $attrs, $source, $taxonomy, $exclude_values, $include_values, $show_children, $show_hierarchical, $show_result_count, $post_type, $post_field, null, $hash );
		...
		if( $show_result_count ) {
			self::update_result_counts( $options_array, $attrs, $source, $taxonomy, $exclude_values, $include_values, $show_children, $show_hierarchical, $show_result_count, $post_type, $post_field, $query_args, $hash );
		}
	...
	public static function get_object_ids ( $query_args ) {
	...
	public static function build_options_array( $attrs, $source, $taxonomy, $exclude_values, $include_values, $show_children, $show_hierarchical, $show_result_count, $post_type, $post_field, $object_ids = null, $hash = '' ) {
		$options_array = [];
	...
	public static function update_result_counts( &$options_array, $attrs, $source, $taxonomy, $exclude_values, $include_values, $show_children, $show_hierarchical, $show_result_count, $post_type, $post_field, $query_args, $hash ) {
		$object_ids = self::get_object_ids( $query_args );
		$new_options_array = self::build_options_array( $attrs, $source, $taxonomy, $exclude_values, $include_values, $show_children, $show_hierarchical, $show_result_count, $post_type, $post_field, $object_ids, $hash );
