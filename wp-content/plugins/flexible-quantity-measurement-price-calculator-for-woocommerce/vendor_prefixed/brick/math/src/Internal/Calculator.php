...
namespace WDFQVendorFree\Brick\Math\Internal;
...
abstract class Calculator
{
     ...
     * @return void
     */
    public static final function set(?\WDFQVendorFree\Brick\Math\Internal\Calculator $calculator) : void
    {
     ...
     */
    public static final function get() : \WDFQVendorFree\Brick\Math\Internal\Calculator
    {
     ...
     * @return Calculator
     */
    private static function detect() : \WDFQVendorFree\Brick\Math\Internal\Calculator
    {
        if (\extension_loaded('gmp')) {
            return new \WDFQVendorFree\Brick\Math\Internal\Calculator\GmpCalculator();
        }
        if (\extension_loaded('bcmath')) {
            return new \WDFQVendorFree\Brick\Math\Internal\Calculator\BcMathCalculator();
        }
        return new \WDFQVendorFree\Brick\Math\Internal\Calculator\NativeCalculator();
    }
    /**
    ...
    public final function divRound(string $a, string $b, int $roundingMode) : string
    {
        ...
        $increment = \false;
        switch ($roundingMode) {
            case \WDFQVendorFree\Brick\Math\RoundingMode::UNNECESSARY:
                if ($hasDiscardedFraction) {
                    throw \WDFQVendorFree\Brick\Math\Exception\RoundingNecessaryException::roundingNecessary();
                }
                break;
            case \WDFQVendorFree\Brick\Math\RoundingMode::UP:
                $increment = $hasDiscardedFraction;
                break;
            case \WDFQVendorFree\Brick\Math\RoundingMode::DOWN:
                break;
            case \WDFQVendorFree\Brick\Math\RoundingMode::CEILING:
                $increment = $hasDiscardedFraction && $isPositiveOrZero;
                break;
            case \WDFQVendorFree\Brick\Math\RoundingMode::FLOOR:
                $increment = $hasDiscardedFraction && !$isPositiveOrZero;
                break;
            case \WDFQVendorFree\Brick\Math\RoundingMode::HALF_UP:
                $increment = $discardedFractionSign() >= 0;
                break;
            case \WDFQVendorFree\Brick\Math\RoundingMode::HALF_DOWN:
                $increment = $discardedFractionSign() > 0;
                break;
            case \WDFQVendorFree\Brick\Math\RoundingMode::HALF_CEILING:
                $increment = $isPositiveOrZero ? $discardedFractionSign() >= 0 : $discardedFractionSign() > 0;
                break;
            case \WDFQVendorFree\Brick\Math\RoundingMode::HALF_FLOOR:
                $increment = $isPositiveOrZero ? $discardedFractionSign() > 0 : $discardedFractionSign() >= 0;
                break;
            case \WDFQVendorFree\Brick\Math\RoundingMode::HALF_EVEN:
