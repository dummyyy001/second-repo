...
namespace WDFQVendorFree\WPDesk\Notice;

use WDFQVendorFree\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use WDFQVendorFree\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
 ...
 */
class AjaxHandler implements \WDFQVendorFree\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    use PluginAccess;
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            $optionName = \WDFQVendorFree\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName;
            ...
            \update_option($optionName, \WDFQVendorFree\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
