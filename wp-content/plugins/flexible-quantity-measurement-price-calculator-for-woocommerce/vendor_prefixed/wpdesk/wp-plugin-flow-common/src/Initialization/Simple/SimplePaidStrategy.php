...
use WDFQVendorFree\WPDesk\Helper\HelperRemover;
use WDFQVendorFree\WPDesk\Helper\PrefixedHelperAsLibrary;
use WDFQVendorFree\WPDesk\License\PluginRegistrator;
use WDFQVendorFree\WPDesk\Plugin\Flow\Initialization\ActivationTrait;
use WDFQVendorFree\WPDesk\Plugin\Flow\Initialization\BuilderTrait;
use WDFQVendorFree\WPDesk\Plugin\Flow\Initialization\PluginDisablerByFileTrait;
...
class SimplePaidStrategy implements \WDFQVendorFree\WPDesk\Plugin\Flow\Initialization\InitializationStrategy
{
    ...
    /** @var SlimPlugin */
    private $plugin;
    public function __construct(\WDFQVendorFree\WPDesk_Plugin_Info $plugin_info)
    {
