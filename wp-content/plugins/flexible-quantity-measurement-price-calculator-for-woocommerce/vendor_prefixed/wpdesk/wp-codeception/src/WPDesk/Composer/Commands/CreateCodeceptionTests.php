 ...
 */
class CreateCodeceptionTests extends \WDFQVendorFree\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \WDFQVendorFree\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
