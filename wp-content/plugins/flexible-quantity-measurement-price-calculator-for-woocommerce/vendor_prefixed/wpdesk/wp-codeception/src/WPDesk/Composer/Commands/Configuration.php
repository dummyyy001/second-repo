...
use WDFQVendorFree\Dotenv\Dotenv;
/**
 * Env.
 */
class Configuration
{
    ...
    {
        $dotenv = \WDFQVendorFree\Dotenv\Dotenv::createImmutable(\getcwd() . '/../');
        $dotenv->safeLoad();
        ...
        if (isset($configuration['plugin-slug'])) {
            ...
            throw new \WDFQVendorFree\WPDesk\Composer\Codeception\Commands\SettingsException('Missing plugin-slug setting!');
        }
        if (isset($configuration['plugin-file'])) {
            $plugin_file = $configuration['plugin-file'];
        } else {
            throw new \WDFQVendorFree\WPDesk\Composer\Codeception\Commands\SettingsException('Missing plugin-file setting!');
        }
        ...
        if (isset($configuration['plugin-title'])) {
            ...
            throw new \WDFQVendorFree\WPDesk\Composer\Codeception\Commands\SettingsException('Missing plugin-title setting!');
        }
