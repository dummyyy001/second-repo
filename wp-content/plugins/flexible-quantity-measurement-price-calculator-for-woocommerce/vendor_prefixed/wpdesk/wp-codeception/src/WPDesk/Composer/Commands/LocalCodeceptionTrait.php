...
trait LocalCodeceptionTrait
{
    ...
    {
        try {
            $wpdesk_configuration = \WDFQVendorFree\Symfony\Component\Yaml\Yaml::parseFile(\getcwd() . '/tests/codeception/wpdesk.yml');
        } catch (\WDFQVendorFree\Symfony\Component\Yaml\Exception\ParseException $e) {
            $wpdesk_configuration = array();
        }
        return \WDFQVendorFree\WPDesk\Composer\Codeception\Commands\Configuration::createFromEnvAndConfiguration($wpdesk_configuration);
    }
    /**
     * @param OutputInterface $output
     * @param Configuration   $configuration
     */
    private function prepareWpConfig(\WDFQVendorFree\Symfony\Component\Console\Output\OutputInterface $output, \WDFQVendorFree\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param Configuration   $configuration
     */
    private function activatePlugins(\WDFQVendorFree\Symfony\Component\Console\Output\OutputInterface $output, \WDFQVendorFree\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     */
    private function executeWpCliAndOutput($command, \WDFQVendorFree\Symfony\Component\Console\Output\OutputInterface $output, $apache_document_root)
    {
     ...
     * @param bool            $coverage
     */
    private function installPlugin(string $plugin_dir, \WDFQVendorFree\Symfony\Component\Console\Output\OutputInterface $output, \WDFQVendorFree\WPDesk\Composer\Codeception\Commands\Configuration $configuration, bool $coverage = \true)
    {
     ...
     * @return string
     */
    private function prepareTargetDir($plugin_slug, \WDFQVendorFree\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param OutputInterface $output
     */
    private function prepareCommonWpWcConfiguration(\WDFQVendorFree\WPDesk\Composer\Codeception\Commands\Configuration $configuration, \WDFQVendorFree\Symfony\Component\Console\Output\OutputInterface $output)
    {
     ...
     */
    private function prepareLocalCodeceptionTests(\WDFQVendorFree\Symfony\Component\Console\Input\InputInterface $input, \WDFQVendorFree\Symfony\Component\Console\Output\OutputInterface $output, bool $coverage = \false)
    {
