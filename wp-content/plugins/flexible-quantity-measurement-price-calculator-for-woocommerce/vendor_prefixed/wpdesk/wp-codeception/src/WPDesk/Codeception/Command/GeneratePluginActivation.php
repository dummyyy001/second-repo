 ...
 */
class GeneratePluginActivation extends \WDFQVendorFree\Codeception\Command\GenerateTest implements \WDFQVendorFree\Codeception\CustomCommandInterface
{
    /**
    ...
    {
        return new \WDFQVendorFree\WPDesk\Codeception\Command\AcceptanceTestGenerator($config, $class);
    }
    /**
     * Execute command.
     *
