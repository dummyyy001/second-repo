 ...
 */
class RunLocalCodeceptionTestsWithCoverage extends \WDFQVendorFree\WPDesk\Composer\Codeception\Commands\RunCodeceptionTests
{
    ...
    {
        parent::configure();
        $this->setName('run-local-codeception-tests-with-coverage')->setDescription('Run local codeception tests.')->setDefinition(array(new \WDFQVendorFree\Symfony\Component\Console\Input\InputArgument(self::SINGLE, \WDFQVendorFree\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Name of Single test to run.', ' ')));
    }
    /**
     * Execute command.
     *
