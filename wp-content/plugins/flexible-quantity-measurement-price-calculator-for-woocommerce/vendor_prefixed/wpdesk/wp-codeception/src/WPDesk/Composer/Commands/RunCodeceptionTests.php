 ...
 */
class RunCodeceptionTests extends \WDFQVendorFree\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    const SINGLE = 'single';
    const FAST = 'fast';
    ...
    {
        parent::configure();
        $this->setName('run-codeception-tests')->setDescription('Run codeception tests.')->setDefinition(array(new \WDFQVendorFree\Symfony\Component\Console\Input\InputArgument(self::SINGLE, \WDFQVendorFree\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Name of Single test to run.', 'all'), new \WDFQVendorFree\Symfony\Component\Console\Input\InputArgument(self::FAST, \WDFQVendorFree\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Fast tests - do not shutdown docker-compose.', 'slow'), new \WDFQVendorFree\Symfony\Component\Console\Input\InputArgument(self::WOOCOMMERCE_VERSION, \WDFQVendorFree\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'WooCommerce version to install.', '')));
    }
    /**
     * Execute command.
     *
