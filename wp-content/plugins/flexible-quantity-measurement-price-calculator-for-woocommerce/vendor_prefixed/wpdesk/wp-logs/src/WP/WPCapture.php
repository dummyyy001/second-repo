...
namespace WDFQVendorFree\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \WDFQVendorFree\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'flexible-quantity-measurement-price-calculator-for-woocommerce'),
            $dir
        ), \WDFQVendorFree\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \WDFQVendorFree\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create file %s!', 'flexible-quantity-measurement-price-calculator-for-woocommerce'),
            $file
        ), \WDFQVendorFree\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
