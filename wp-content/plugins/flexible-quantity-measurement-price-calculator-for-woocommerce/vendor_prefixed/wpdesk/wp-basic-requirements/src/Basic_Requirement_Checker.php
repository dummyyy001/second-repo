...
if (!\interface_exists('WDFQVendorFree\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('WDFQVendorFree\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \WDFQVendorFree\WPDesk_Requirement_Checker
    {
