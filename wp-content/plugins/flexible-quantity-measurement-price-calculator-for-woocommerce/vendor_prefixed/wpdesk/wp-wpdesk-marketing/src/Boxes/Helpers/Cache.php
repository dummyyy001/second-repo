 ...
 */
namespace WDFQVendorFree\WPDesk\Library\Marketing\Boxes\Helpers;
...
class Cache
{
    ...
    {
        return self::MARKETING_SLUG . \WDFQVendorFree\WPDesk\Library\Marketing\Boxes\MarketingBoxes::VERSION . '_' . $plugin_slug . '_' . $lang;
    }
}
