 ...
 */
namespace WDFQVendorFree\WPDesk\Library\Marketing\Boxes\Api;
...
class Client
{
    const URL = 'https://marketing.wpdesk.org/json/' . \WDFQVendorFree\WPDesk\Library\Marketing\Boxes\MarketingBoxes::VERSION . '/boxes/';
    /** @var string */
    private $plugin_slug;
