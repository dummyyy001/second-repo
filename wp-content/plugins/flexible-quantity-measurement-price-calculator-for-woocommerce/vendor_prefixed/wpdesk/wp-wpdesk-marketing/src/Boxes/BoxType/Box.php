 ...
 */
class Box implements \WDFQVendorFree\WPDesk\Library\Marketing\Boxes\Abstracts\BoxInterface
{
    const TYPE = 'simple';
    /**
     * @var array{
     ...
     * @param array    $box
     */
    public function __construct(array $box, \WDFQVendorFree\WPDesk\View\Renderer\Renderer $renderer)
    {
        $this->box = $box;
