...
namespace WDFQVendorFree\WPDesk\Dashboard;

final class DashboardWidget
{
    const ID = 'flexible-quantity-measurement-price-calculator-for-woocommerce';
    ...
    {
        $this->widget_title = \__('Grow your business with WP Desk', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
    ...
    private function show_plugins(array $plugins, bool $for_free = \false)
    {
        ...
        foreach ($plugins as $plugin) {
            ...
            $add_to_cart_button_label = \esc_html__('Buy now', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
            if ($plugin['add_to_cart_id'] === self::WP_DESK_CARE_ID) {
                $add_to_cart_button_label = \esc_html__('Learn more', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
                $add_to_cart_url = $plugin_url;
            } else {
                if ($plugin['add_to_cart_id'] === self::AUTOPAY_ID) {
                    $add_to_cart_button_label = \esc_html__('Download', 'flexible-quantity-measurement-price-calculator-for-woocommerce');
            ...
            if ($for_free) {
                echo '<a class="button button-primary" href="' . \esc_url($plugin_url) . '" target="_blank">' . \esc_html__('More info', 'flexible-quantity-measurement-price-calculator-for-woocommerce') . '</a>';
