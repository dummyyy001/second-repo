...
use WDFQVendorFree\WPDesk\Persistence\AllDataAccessContainer;
/**
 * You can use this class to delay write access to any PersistenceContainer and save it as single value.
 *
 * @package WPDesk\Persistence
 */
final class DelaySinglePersistentContainer extends \WDFQVendorFree\WPDesk\Persistence\Decorator\DelayPersistentContainer implements \WDFQVendorFree\WPDesk\Persistence\AllDataAccessContainer
{
    /**
     ...
     */
    private $key;
    public function __construct(\WDFQVendorFree\WPDesk\Persistence\PersistentContainer $container, string $key)
    {
