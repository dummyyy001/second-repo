...
if (!\interface_exists('WDFQVendorFree\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('WDFQVendorFree\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \WDFQVendorFree\WPDesk_Translatable, \WDFQVendorFree\WPDesk_Buildable, \WDFQVendorFree\WPDesk_Has_Plugin_Info
{
    /** @var string */
