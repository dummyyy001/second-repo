...
namespace WDFQVendorFree\WPDesk\PluginBuilder\Builder;

use WDFQVendorFree\WPDesk\PluginBuilder\Plugin\AbstractPlugin;
use WDFQVendorFree\WPDesk\PluginBuilder\Plugin\ActivationAware;
use WDFQVendorFree\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
 ...
 */
class InfoActivationBuilder extends \WDFQVendorFree\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
     ...
     */
    public function __construct(\WDFQVendorFree\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \WDFQVendorFree\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\WDFQVendorFree\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
