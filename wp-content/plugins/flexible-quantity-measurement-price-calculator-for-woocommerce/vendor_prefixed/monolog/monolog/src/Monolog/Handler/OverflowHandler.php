 ...
 */
class OverflowHandler extends \WDFQVendorFree\Monolog\Handler\AbstractHandler implements \WDFQVendorFree\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\WDFQVendorFree\Monolog\Logger::DEBUG => 0, \WDFQVendorFree\Monolog\Logger::INFO => 0, \WDFQVendorFree\Monolog\Logger::NOTICE => 0, \WDFQVendorFree\Monolog\Logger::WARNING => 0, \WDFQVendorFree\Monolog\Logger::ERROR => 0, \WDFQVendorFree\Monolog\Logger::CRITICAL => 0, \WDFQVendorFree\Monolog\Logger::ALERT => 0, \WDFQVendorFree\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     */
    public function __construct(\WDFQVendorFree\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \WDFQVendorFree\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
