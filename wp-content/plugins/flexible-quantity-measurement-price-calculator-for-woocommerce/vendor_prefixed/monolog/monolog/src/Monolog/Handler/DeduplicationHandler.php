 ...
 */
class DeduplicationHandler extends \WDFQVendorFree\Monolog\Handler\BufferHandler
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(\WDFQVendorFree\Monolog\Handler\HandlerInterface $handler, ?string $deduplicationStore = null, $deduplicationLevel = \WDFQVendorFree\Monolog\Logger::ERROR, int $time = 60, bool $bubble = \true)
    {
        parent::__construct($handler, 0, \WDFQVendorFree\Monolog\Logger::DEBUG, $bubble, \false);
        $this->deduplicationStore = $deduplicationStore === null ? \sys_get_temp_dir() . '/monolog-dedup-' . \substr(\md5(__FILE__), 0, 20) . '.log' : $deduplicationStore;
        $this->deduplicationLevel = \WDFQVendorFree\Monolog\Logger::toMonologLevel($deduplicationLevel);
        $this->time = $time;
    }
