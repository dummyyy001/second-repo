 ...
 */
class IntrospectionProcessor implements \WDFQVendorFree\Monolog\Processor\ProcessorInterface
{
    /** @var int */
    private $level;
    /** @var string[] */
     ...
     */
    public function __construct($level = \WDFQVendorFree\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
