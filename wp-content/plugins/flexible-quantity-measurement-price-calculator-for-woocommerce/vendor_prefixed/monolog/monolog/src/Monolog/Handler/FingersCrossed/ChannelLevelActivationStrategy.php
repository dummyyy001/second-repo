 ...
 */
class ChannelLevelActivationStrategy implements \WDFQVendorFree\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var Level
     */
    ...
    {
        $this->defaultActionLevel = \WDFQVendorFree\Monolog\Logger::toMonologLevel($defaultActionLevel);
