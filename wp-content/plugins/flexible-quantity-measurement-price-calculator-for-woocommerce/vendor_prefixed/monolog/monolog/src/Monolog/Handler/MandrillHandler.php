 ...
 */
class MandrillHandler extends \WDFQVendorFree\Monolog\Handler\MailHandler
{
    /** @var Swift_Message */
    protected $message;
    /** @var string */
     ...
     */
    public function __construct(string $apiKey, $message, $level = \WDFQVendorFree\Monolog\Logger::ERROR, bool $bubble = \true)
    {
        parent::__construct($level, $bubble);
        if (!$message instanceof \WDFQVendorFree\Swift_Message && \is_callable($message)) {
            $message = $message();
        }
