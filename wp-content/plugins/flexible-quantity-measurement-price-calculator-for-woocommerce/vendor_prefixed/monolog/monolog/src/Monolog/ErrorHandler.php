...
class ErrorHandler
{
    ...
    private function handleException(\Throwable $e) : void
    {
        ...
        $this->logger->log($level, \sprintf('Uncaught Exception %s: "%s" at %s line %s', \WDFQVendorFree\Monolog\Utils::getClass($e), $e->getMessage(), $e->getFile(), $e->getLine()), ['exception' => $e]);
    ...
    public function handleFatalError() : void
    {
        ...
        if ($lastError && \in_array($lastError['type'], self::$fatalErrors, \true)) {
            ...
            if ($this->logger instanceof \WDFQVendorFree\Monolog\Logger) {
