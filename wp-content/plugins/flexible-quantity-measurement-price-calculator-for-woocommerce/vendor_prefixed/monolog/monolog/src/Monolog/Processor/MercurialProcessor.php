 ...
 */
class MercurialProcessor implements \WDFQVendorFree\Monolog\Processor\ProcessorInterface
{
    /** @var Level */
    private $level;
     ...
     */
    public function __construct($level = \WDFQVendorFree\Monolog\Logger::DEBUG)
    {
