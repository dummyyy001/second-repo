...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\WDFQVendorFree\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \WDFQVendorFree\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \WDFQVendorFree\Monolog\Logger
    {
