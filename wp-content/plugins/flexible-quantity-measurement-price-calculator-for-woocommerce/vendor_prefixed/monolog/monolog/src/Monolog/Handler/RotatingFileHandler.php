 ...
 */
class RotatingFileHandler extends \WDFQVendorFree\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \WDFQVendorFree\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \WDFQVendorFree\Monolog\Utils::canonicalizePath($filename);
