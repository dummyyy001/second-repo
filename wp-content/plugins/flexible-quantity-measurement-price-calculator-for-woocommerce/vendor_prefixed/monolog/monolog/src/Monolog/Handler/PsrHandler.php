 ...
 */
class PsrHandler extends \WDFQVendorFree\Monolog\Handler\AbstractHandler implements \WDFQVendorFree\Monolog\Handler\FormattableHandlerInterface
{
    /**
     ...
     */
    public function __construct(\Psr\Log\LoggerInterface $logger, $level = \WDFQVendorFree\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
