 ...
 */
abstract class AbstractSyslogHandler extends \WDFQVendorFree\Monolog\Handler\AbstractProcessingHandler
{
    /** @var int */
    protected $facility;
    /**
     ...
     */
    protected $logLevels = [\WDFQVendorFree\Monolog\Logger::DEBUG => \LOG_DEBUG, \WDFQVendorFree\Monolog\Logger::INFO => \LOG_INFO, \WDFQVendorFree\Monolog\Logger::NOTICE => \LOG_NOTICE, \WDFQVendorFree\Monolog\Logger::WARNING => \LOG_WARNING, \WDFQVendorFree\Monolog\Logger::ERROR => \LOG_ERR, \WDFQVendorFree\Monolog\Logger::CRITICAL => \LOG_CRIT, \WDFQVendorFree\Monolog\Logger::ALERT => \LOG_ALERT, \WDFQVendorFree\Monolog\Logger::EMERGENCY => \LOG_EMERG];
    /**
     ...
     */
    public function __construct($facility = \LOG_USER, $level = \WDFQVendorFree\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    {
        return new \WDFQVendorFree\Monolog\Formatter\LineFormatter('%channel%.%level_name%: %message% %context% %extra%');
    }
}
