 ...
 */
class RedisPubSubHandler extends \WDFQVendorFree\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \WDFQVendorFree\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
