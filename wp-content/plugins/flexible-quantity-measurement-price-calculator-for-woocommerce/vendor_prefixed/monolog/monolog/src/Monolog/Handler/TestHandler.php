 ...
 */
class TestHandler extends \WDFQVendorFree\Monolog\Handler\AbstractProcessingHandler
{
    /** @var Record[] */
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\WDFQVendorFree\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
    ...
    {
        $level = \WDFQVendorFree\Monolog\Logger::toMonologLevel($level);
