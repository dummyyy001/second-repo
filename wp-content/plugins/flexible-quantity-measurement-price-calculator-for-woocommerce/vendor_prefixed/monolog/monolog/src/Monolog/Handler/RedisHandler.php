 ...
 */
class RedisHandler extends \WDFQVendorFree\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \WDFQVendorFree\Monolog\Logger::DEBUG, bool $bubble = \true, int $capSize = 0)
    {
        if (!($redis instanceof \WDFQVendorFree\Predis\Client || $redis instanceof \Redis)) {
