 ...
 */
class NativeMailerHandler extends \WDFQVendorFree\Monolog\Handler\MailHandler
{
    /**
     ...
     */
    public function __construct($to, string $subject, string $from, $level = \WDFQVendorFree\Monolog\Logger::ERROR, bool $bubble = \true, int $maxColumnWidth = 70)
    {
    ...
    protected function send(string $content, array $records) : void
    {
        ...
        if ($records) {
            $subjectFormatter = new \WDFQVendorFree\Monolog\Formatter\LineFormatter($this->subject);
