 ...
 */
namespace WDFQVendorFree\Monolog\Handler\Slack;
...
class SlackRecord
{
     ...
     */
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), \WDFQVendorFree\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \WDFQVendorFree\Monolog\Formatter\NormalizerFormatter();
        }
    }
    /**
    ...
    {
        switch (\true) {
            case $level >= \WDFQVendorFree\Monolog\Logger::ERROR:
                return static::COLOR_DANGER;
            case $level >= \WDFQVendorFree\Monolog\Logger::WARNING:
                return static::COLOR_WARNING;
            case $level >= \WDFQVendorFree\Monolog\Logger::INFO:
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \WDFQVendorFree\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \WDFQVendorFree\Monolog\Utils::DEFAULT_JSON_FLAGS) : \WDFQVendorFree\Monolog\Utils::jsonEncode($normalized, \WDFQVendorFree\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\WDFQVendorFree\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
