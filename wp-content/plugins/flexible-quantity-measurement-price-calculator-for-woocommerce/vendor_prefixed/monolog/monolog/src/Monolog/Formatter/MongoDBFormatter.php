 ...
 */
class MongoDBFormatter implements \WDFQVendorFree\Monolog\Formatter\FormatterInterface
{
    /** @var bool */
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \WDFQVendorFree\Monolog\Utils::getClass($value);
    ...
    {
        $formattedException = ['class' => \WDFQVendorFree\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
