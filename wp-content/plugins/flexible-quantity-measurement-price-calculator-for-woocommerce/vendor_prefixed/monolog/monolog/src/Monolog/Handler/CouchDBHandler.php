 ...
 */
class CouchDBHandler extends \WDFQVendorFree\Monolog\Handler\AbstractProcessingHandler
{
    /** @var mixed[] */
    private $options;
    /**
     * @param mixed[] $options
     */
    public function __construct(array $options = [], $level = \WDFQVendorFree\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
